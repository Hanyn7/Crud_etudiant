...
class _StudentListWidgetState extends State<StudentListWidget> {
  ...
  Future<List<Student>> fetchStudents() async {
    final response =
        await http.get(Uri.parse('http://192.168.189.101:3004/students'));
  ...
  List<Student> filterStudentsByBirthYear(
      List<Student> students, int birthYear) {
        ...
        return AlertDialog(
          ...
          content: TextField(
            ...
            onChanged: (value) async {
              ...
              setState(() {
                _filteredStudents =
                    filterStudentsByBirthYear(students, birthYear);
              });
            },
  ...
  void _deleteStudent(int studentId) async {
    final response = await http
        .delete(Uri.parse('http://192.168.189.101:3004/students/$studentId'));
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                                '${displayedStudents[index].address}'),
                                          ],
                                        ),
                                      ),
                                    ),
                                    TableCell(
                                      child: Padding(
                                        ...
                                        child: Column(
                                          crossAxisAlignment:
                                              CrossAxisAlignment.start,
                                          children: displayedStudents[index]
                                              .courses
                                              .map((course) {
                                            return Text(
